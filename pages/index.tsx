        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="200">
              <Image src="/assets/img/hero-img.png" className="img-fluid animated" width={120} height={120}  alt=""/>
            </div>
          </div>
        </div>
          ...
          <div className="container">
            ...
            <div className="row" data-aos="zoom-in">
              ...
              <div className="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                <Image src="/assets/img/clients/FMI5_1.png" className="img-fluid" width={200} height={120}  alt=""/>
              </div>

              <div className="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                <Image src="/assets/img/clients/ASMI.png" className="img-fluid" width={120} height={120}  alt=""/>
              </div>

              <div className="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
                <Image src="/assets/img/clients/LogoUB.png" className="img-fluid" width={200} height={120}  alt=""/>
              </div>
          ...
          <div className="container" data-aos="fade-up">
            ...
            <div className="row">
              <div className="col-lg-6 d-flex align-items-center" data-aos="fade-right" data-aos-delay="100">
                <Image src="/assets/img/skills.png" className="img-fluid" width={120} height={120}  alt=""/>
              </div>
            ...
            <div className="row">
              ...
              <div className="col-lg-6">
                <div className="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="100">
                  <div className="pic"><Image src="/assets/img/team/team-1.jpg" className="img-fluid" width={120} height={120}  alt=""/></div>
                  <div className="member-info">
                    <h4>Walter White</h4>
                    <span>Chief Executive Officer</span>
                    <p>Explicabo voluptatem mollitia et repellat qui dolorum quasi</p>
                    <div className="social">
                      <a href=""><i className="ri-twitter-width={120} height={120} "></i></a>
                      <a href=""><i className="ri-facebook-width={120} height={120} "></i></a>
                      <a href=""><i className="ri-instagram-width={120} height={120} "></i></a>
                      <a href=""> <i className="ri-linkedin-box-width={120} height={120} "></i> </a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-6 mt-4 mt-lg-0">
                <div className="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="200">
                  <div className="pic"><Image src="/assets/img/team/team-2.jpg" className="img-fluid" width={120} height={120}  alt=""/></div>
                  <div className="member-info">
                    <h4>Sarah Jhonson</h4>
              ...
              <div className="col-lg-6 mt-4">
                <div className="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="300">
                  <div className="pic"><Image src="/assets/img/team/team-3.jpg" className="img-fluid" width={120} height={120}  alt=""/></div>
                  <div className="member-info">
              ...
              <div className="col-lg-6 mt-4">
                <div className="member d-flex align-items-start" data-aos="zoom-in" data-aos-delay="400">
                  <div className="pic"><Image src="/assets/img/team/team-4.jpg" className="img-fluid" width={120} height={120}  alt=""/></div>
                  <div className="member-info">
                    <h4>Amanda Jepson</h4>
